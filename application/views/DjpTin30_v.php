...
<script type="text/javascript">
    ...
    function get30(stDate){
        showModal();
        var url = "http://172.16.3.126:8080/testla/rest-points/asmgService/djpTin30/"+stDate;
        $.ajax({
            url: url,
            dataType: 'json'
        }).done(function( msg ) {
            ...
            $('#headTable').append('<tr><th>DocRefID_AccountReport</th><th>DocRefID_ControllingPerson</th><th>ResCountryCode</th><th>Nationality</th><th>BirthInfo_BirthDate</th><th>BirthInfo_City</th><th>BirthInfo_CountryCode</th><th>CtrlPersonType</th></tr>');
            $("#myModal").modal("hide");
            $.each(JSON.parse(msg), function(key, val) {
                $('#bodyTable').append('<tr><td>'+val.DocRefID_AccountReport+'</td><td>'+val.DocRefID_ControllingPerson+'</td><td>'+val.ResCountryCode+'</td><td>'+val.Nationality+'</td><td>'+val.BirthInfo_BirthDate+'</td><td>'+val.BirthInfo_City+'</td><td>'+val.BirthInfo_CountryCode+'</td><td>'+val.CtrlPersonType+'</td></tr>');
            });    
        });        
    }
	function showModal() {
