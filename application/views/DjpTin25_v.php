...
<script type="text/javascript">
    ...
    function get24(stDate){
         showModal();
        var url = "http://172.16.3.126:8080/testla/rest-points/asmgService/djpTin25/"+stDate;
        $.ajax({
            url: url,
            dataType: 'json'
        }).done(function( msg ) {
            ...
            $('#headTable').append('<tr><th>DocRefID_AccountReport</th><th>legalAddressType</th><th>CountryCode</th><th>AddressFree</th><th>Street</th><th>BuildingIdentifier</th><th>SuiteIdentifier</th><th>FloorIdentifier</th><th>DistrictName</th><th>POB</th><th>PostCode</th><th>City</th><th>CountrySubentity</th></tr>');
            $("#myModal").modal("hide");
            $.each(JSON.parse(msg), function(key, val) {
                $('#bodyTable').append('<tr><td>'+val.DocRefID_AccountReport+'</td><td>'+val.legalAddressType+'</td><td>'+val.CountryCode+'</td><td>'+val.AddressFree+'</td><td>'+val.Street+'</td><td>'+val.BuildingIdentifier+'</td><td>'+val.SuiteIdentifier+'</td><td>'+val.FloorIdentifier+'</td><td>'+val.DistrictName+'</td><td>'+val.POB+'</td><td>'+val.PostCode+'</td><td>'+val.City+'</td><td>'+val.CountrySubentity+'</td></tr>');
            });    
        });        
    }
	function showModal() {
