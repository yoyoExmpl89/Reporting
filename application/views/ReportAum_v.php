...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        $("#formkirim").submit(function(e){
			e.preventDefault();
            getAum($("#datepicker").val(),$('#SelectQty option:selected').val());
    ...
    function getAum(startDate,qty){
        showModal();
        var url = "http://172.16.3.126:8080/testla/rest-points/asmgService/selectbyAum/"+startDate+"/"+qty;
        $.ajax({
            url: url,
            dataType: 'json'
        }).done(function( msg ) {
